(define (problem drone_problem_d10_r10_l3_p3_c3_g3_ct2)
(:domain p2)
(:objects
	drone1 - drone
	drone2 - drone
...
(:init
	...
	(drone-free drone5)
	(drone-at drone6 depot)
	(drone-free drone6)
	(drone-at drone7 depot)
	(drone-free drone7)
	(drone-at drone8 depot)
	(drone-free drone8)
	(drone-at drone9 depot)
	(drone-free drone9)
	(drone-at drone10 depot)
	(drone-free drone10)
	...
	(carrier-at carrier6 depot)
	(carrier-free carrier6)
	(carrier-capacity carrier6 N4)
	(crates-in-carrier carrier6 N0)
	(carrier-at carrier7 depot)
	(carrier-free carrier7)
	(carrier-capacity carrier7 N4)
	(crates-in-carrier carrier7 N0)
	(carrier-at carrier8 depot)
	(carrier-free carrier8)
	(carrier-capacity carrier8 N4)
	(crates-in-carrier carrier8 N0)
	(carrier-at carrier9 depot)
	(carrier-free carrier9)
	(carrier-capacity carrier9 N4)
	(crates-in-carrier carrier9 N0)
	(carrier-at carrier10 depot)
	(carrier-free carrier10)
	(carrier-capacity carrier10 N4)
	(crates-in-carrier carrier10 N0)
