...
In the second part numbers have been added. Listings bellow ilustrate how currently defined problems are resulted. 
...
\end{tabular}
\caption{Performance Comparison of GBFS and EHC with Various Heuristics (Exercise 2.1)}
\label{tab:results_2_1_4_2}
\end{table}
...
\end{tabular}
\caption{Performance of Optimal Planners and Admissible Heuristics (Exercise 2.1)}
\label{tab:results_2_1_4_3}
\end{table}
...
Fast Downward & seq-sat-fdss-2 & 352 & ?? & 0 \\ \hline
